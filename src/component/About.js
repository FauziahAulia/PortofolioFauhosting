                        ...
                        <div class="rounded">
                            <div class="row">
                                <div class="about-text padd-15">
                                    <p>Hai saya Fauziah Aulia (Pao). Lahir di Banyuasin, 18 Februari 2005. Have a nice day!! and Thankyou.. </p>
                                </div>
                                <div class="skills padd-15">
                                    <div class="row">
                                        ...
                                        <div class="skill-item">
                                            <h4>CSS</h4>
                                            <div class="progress">
                                                <div class="progress-in" style={{ width: '45%', background: 'rgb(255,76,96)' }}></div>
                                        ...
                                        <div class="skill-item">
                                            <h4>JavaScript</h4>
                                            <div class="progress">
                                                <div class="progress-in" style={{ width: '5%', background: 'rgb(108,108,229)' }}></div>
